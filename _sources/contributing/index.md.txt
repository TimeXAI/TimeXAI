(contributing_guide)=
# Contributing to TimeXAI
## Welcome
Welcome to the {doc}`TimeXAI` project!
If you’re reading this guide, that probably means you’d like to get involved
and start contributing to the project.
TimeXAI is a  multi-language open-source project that provides tools for exploratory analysis of Bayesian models.
...
make their contributions compliant with the conventions of the TimeXAI python library,
and maximize the probability of such contributions being merged as quickly and as efficiently as possible.

All kinds of contributions to TimeXAI, either on its codebase, its documentation,
...
and participate in {ref}`TimeXAI governance <TimeXAI_org:governance>`.

## Before you begin
Before contributing to TimeXAI, please make sure to read and observe the [Code of Conduct](https://github.com/TimeXAI-devs/TimeXAI/blob/main/CODE_OF_CONDUCT.md).

## Communication
Contact us on [Gitter](https://gitter.im/TimeXAI-devs/community)
...
sending pull requests on the main [TimeXAI Github repository](https://github.com/TimeXAI-devs/TimeXAI),
...
to TimeXAI. If you prefer video instead of written form, jump to the next section:
{ref}`contributing_webinar` for a recording of an TimeXAI core contributor
on both technical and social aspects of contributing to the library.

You can contribute to TimeXAI in the following ways:

### Create an issue
[Submit issues](https://github.com/TimeXAI-devs/TimeXAI/issues/new/choose) for existing bugs or desired enhancements. Check  {ref}`issue_reports` for details on how to write an issue.

### Translate TimeXAI website
...
### Write documentation
You can contribute to TimeXAI’s documentation by either creating new content or editing existing content.
For instance, you can add new TimeXAI examples.
...
Support TimeXAI {ref}`outreach initiatives <oureach_contrib>` such as writing blog posts, case studies, getting people to use TimeXAI at your company or university, etc.
...
## Contributing to TimeXAI webinar
