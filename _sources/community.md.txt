(community)=
# Community
TimeXAI is a community-driven open source project committed to host an open,
inclusive and positive community. Read the
[TimeXAI Code of Conduct](https://github.com/TimeXAI-devs/TimeXAI/blob/main/CODE_OF_CONDUCT.md)
...
* Creating and maintaining the TimeXAI library with functions for posterior analysis, data storage,
...
This page aims to gather resources related to Bayesian modeling and TimeXAI from a variety of
sources to work towards the 2nd and 3rd bullet points.
This page covers how can someone participate in the TimeXAI community (this someone could be you!),
gives an overview of the ecosystem of Python libraries for Bayesian analysis and serves
as a compilation for community resources around TimeXAI.

*But what is the TimeXAI community?*
The TimeXAI community is a self-identifying group composed of probabilistic programming practitioners who,
...
Community members are people who use, cite and share use cases for TimeXAI,
write posts or give talks about using TimeXAI,
participate in issues to help define the roadmap and improve the project,
or answer questions in any of the affine forums.

This page is part of the Python TimeXAI library and is therefore specific to Python,
but the TimeXAI community is not restricted to Python and in fact, aims to act as a bridge
...
TimeXAI is a transversal and backend agnostic project. One can use TimeXAI with _any_ PPL,
but one has to be used in order to have some data for TimeXAI to analyze.
This makes writing detailed and complete documentation for TimeXAI complicated.
This section aims to act as a compilation of community resources related to TimeXAI
that hopefully can bridge the gap. These can be books, case studies in the documentation of
PPLs, personal blogs...

Do you know of resources about TimeXAI that are not listed here? Open an issue or a PR and
let us know!
...
If you have a blog that has 2 or more posts tagged as "TimeXAI", you can submit
a pull request to add your blog to this list

## Participate online
There are many alternatives and channels available to interact with other TimeXAI users.
